defmodule Theme01.TimeManager do
  @moduledoc """
  ...
  def list_working_times_by_user_and_dates(user_id, start_date, end_date) do
  ...
  # Fonction pour lister toutes les périodes de travail d'un utilisateur spécifique
